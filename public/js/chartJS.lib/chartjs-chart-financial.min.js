      ...
      tooltip: {
        ...
        callbacks: {
          label(ctx) {
            ...
            const {o, h, l, c, DONG , HO} = point;
            
            const formatter = new Intl.NumberFormat('en-US');
            
            const oS = formatter.format(o);
            const hS = formatter.format(h);
            const lS = formatter.format(l);
            const cS = formatter.format(c);
            

            return `O: ${oS}  H: ${hS}  L: ${lS}  C: ${cS}  (${DONG}동 ${HO}호)`;
          }
        }
      }
    }
...
class FinancialElement extends chart_js.BarElement {
  ...
  static defaults = {
    backgroundColors: {
      up: 'rgba(255, 99, 132, 1)',
      down: 'rgba(91, 145, 255, 1)',
...
class CandlestickElement extends FinancialElement {
  ...
  draw(ctx) {
    ...
    ctx.stroke();
    ctx.fillRect(x - 50 / 10, close, 10, open - close);
    ctx.strokeRect(x - 50 / 10, close, 10, open - close);
    ctx.closePath();
  }
}
